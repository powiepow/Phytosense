                ...
                <div class="lower_t">
                    ...
                    <div class="table-wrapper">
                        <table class="fl-table">
                            ...
                            <caption style="padding:10px; background:#5e8e56; color:white;"><h2>User Type</h2></caption>
